...
public class Basket1 {
	...
	public void test() {
		...
		while(it.hasNext()) {
		    ...
		    BigDecimal mrp=new BigDecimal(skuDetailsFromCache.substring(9, skuDetailsFromCache.length()));
		    ...
		    //Create SKU hierarchy
		    	...
		    	if(skuHierarchy.length()>14 && promoCache.promoCached.containsKey(skuHierarchy+skuNumber) ){
		    	...
		    	if(skuHierarchy.length()>10 && promoCache.promoCached.containsKey(skuHierarchy) ){
		    	...
		    	if(skuHierarchy.length()>7 && promoCache.promoCached.containsKey(skuHierarchy.substring(0, 10)) ){
		    	...
		    	if(skuHierarchy.length()>3 && promoCache.promoCached.containsKey(skuHierarchy.substring(0,7)) ){
		    	...
		    	if(skuHierarchy.length()>2 && promoCache.promoCached.containsKey(skuHierarchy.substring(0,3)) )
			    	promoSet.addAll(promoCache.promoCached.get(skuHierarchy.substring(0,3)));
